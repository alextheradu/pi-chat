...
export function SidebarChannelItem({ id, name, isPrivate, isAnnouncement, unreadCount = 0 }: SidebarChannelItemProps) {
  ...
  return (
    <Link
      ...
      style={{
        ...
        cursor: 'pointer', textDecoration: 'none', fontSize: 13, fontFamily: 'var(--font-sans)',
        color: isActive ? 'var(--yellow)' : 'var(--text-secondary)',
        background: isActive ? 'var(--bg-active)' : 'transparent',
        borderLeft: isActive ? '3px solid var(--yellow)' : '3px solid transparent',
        transition: 'background 80ms ease, color 80ms ease', userSelect: 'none',
      }}
    ...
    >
      ...
      {unreadCount > 0 && (
        <span style={{
          background: 'var(--yellow)', color: 'var(--text-inverse)', fontFamily: 'var(--font-mono)',
